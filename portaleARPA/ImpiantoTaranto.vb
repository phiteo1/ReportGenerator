...
Public Class ImpiantoTaranto
                                                           ...
                                                           Select Case index
                                                               ...
                                                               Case 4
                                                                   If (Form1.reportType = 0) Then
                                                                       ...
                                                                       UpdateTextBoxText(formInstance, formInstance.TextBox1, "Year " & Form1.startDate.Year.ToString & " downloaded succesfully")

                                                                   ElseIf (Form1.reportType = 1) Then

                                                                       UpdateTextBoxText(formInstance, formInstance.TextBox1, "Month " & String.Format(New System.Globalization.CultureInfo("it-IT"), "{0:MMMM yyyy}", Date.Parse(Form1.startDate)) & " downloaded succesfully")
    ...
    Private Sub EnableControls(container As Control)
        For Each ctrl As Control In container.Controls
            If Not ctrl.Equals(Form1.dgv) AndAlso Not ctrl.Equals(Form1.dgv2) AndAlso Not ctrl.Enabled Then
                ctrl.Enabled = True
            End If
